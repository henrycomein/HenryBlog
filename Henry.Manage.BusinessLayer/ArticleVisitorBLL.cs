...
namespace Henry.Manage.BusinessLayer
{
    public class ArticleVisitorBLL
    {
        ...
        public static bool Add(ArticleVisitor info)
        {
            return ArticleVisitorDAL.AddOrUpdate(info);
        }
        ...
        /// <returns></returns>
        public static bool Update(ArticleVisitor info)
        {
            return ArticleVisitorDAL.AddOrUpdate(info);
        }
        ...
        {
            return ArticleVisitorDAL.UpdateStatus(id, 0); 
        }
        ...
        {
            return ArticleVisitorDAL.UpdateStatus(id, 1);
        }
        ...
        {
            return ArticleVisitorDAL.UpdateStatus(id, 2);
        }
